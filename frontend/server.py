...
class APIHandler(BaseHTTPRequestHandler): 
    ...
    def do_OPTIONS(self):
        # Configura l'header CORS per consentire l'accesso da qualsiasi origine per tutti i metodi
        self.send_response(200)
        self.send_header('Access-Control-Allow-Origin', '*')
        self.send_header('Access-Control-Allow-Methods', 'GET, POST, PUT, PATCH, DELETE, OPTIONS')  # Specifica tutti i metodi consentiti
