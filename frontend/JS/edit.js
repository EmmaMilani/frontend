    ...
    fetch(`http://localhost:8000/products/${product_id}`)
        ...
        .then(data => {
            ...
            modalContent.innerHTML = `
                ...
                <h2>Show Product</h2>
                <label>Nome</label><br>
                <input type="text" id="Nome" value="${data.data.attributes.nome}">
                <br><br>
                <label>Marca</label><br>
                <input type="text" id="Marca" value="${data.data.attributes.marca}">
                <br><br>
                <label>Prezzo</label><br>
                <input type="number" id="Prezzo" value="${data.data.attributes.prezzo}">
                <br><br>
                <button onclick="closeModal()">Close</button>
                <button onclick="Edit(${data.data.id})">Edit</button>
            `;
